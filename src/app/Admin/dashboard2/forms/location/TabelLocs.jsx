            ...
            {datax
              ...
              .map((cb, i) => {
                ...
                const handleAccept = async (e) => {
                  ...
                  const response = await fetch("/api/v1/dataAlamat/accept", {
                    method: "POST",
                ...
                const handleReject = async (e) => {
                  ...
                  const response = await fetch("/api/v1/dataAlamat/reject", {
                    method: "POST",
                    body: JSON.stringify(data),
                  });
                  const show = await response.json();
